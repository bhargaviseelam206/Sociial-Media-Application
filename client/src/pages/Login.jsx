...
const Login = () => {
  return (
    <div className='min-h-screen flex flex-col md:flex-row'>
      {/*Background Image*/}
      <img src="https://img.freepik.com/premium-photo/yellow-pattern-background-banner-with-copy-space-text-your-images_7954-43680.jpg" alt="" className='absolute top-0 left-0 -z-1 w-full h-full object-cover'/>
      {/*left side:Branding*/}
