    ...
    <div className='fixed top-0 bottom-0 left-0 right-0 z-110 h-screen overflow-y-scroll bg-black/50'>
      <div className='max-w-2xl sm:py-6 mx-auto'>
        ...
        <div className='bg-white rounded-lg shadow p-6'>
            ...
            <form className='space-y-4' submit={handleSaveProfile}>
                {/*Profile Picture*/}
                <div>
                ...
                <div>
                    ...
                    <input type="text" className='w-full p-3 border border-gray-200 rounded-lg' placeholder='Please enter your user name'
                ...
                <div>
                    ...
                    <textarea rows={3} type="text" className='w-full p-3 border border-gray-200 rounded-lg' placeholder='Please enter your short bio'
